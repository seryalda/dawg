...
|----------------------------------------|---------------------------------------------------------------------------------------------------------|---------------------------|---------------------------|
| **Foghorn v1.0.0** <img src="[./foghorn/1.0.0
/3dv1.png](https://github.com/seryalda/foghorn/raw/main/1.0.0/3dv1.png)" alt="PCB Back" width="300"> | [FOGHORN](https://github.com/seryalda/foghorn) | The board seamlessly integrates with the Foghorn Version 1.0.0 Processor Board. This processor board is an ESP8266 NodeMCU v3 compatible board with ready connect screw terminal block output mapped to GPIO pins 4, 5, 12, and 14 of the microcontroller allowing you to effortlessly control up to 4 external switch relays or CONTACTORS. | 4, 5, 12, 14              |
